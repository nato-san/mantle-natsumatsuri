...
アプリ自体を共有する時は、`?festival=...` が付いていないURLを案内します。開いた人はトップの `お祭りを作る` から自分の家専用のお祭りURLを作れます。
...
このURLから `お祭りを作る` を押すと、その家専用のお祭りURLができます。
...
公開後は、まずアプリのトップURLを共有します。使う人は `お祭りを作る` を押して自分の家のお祭りを作ります。
